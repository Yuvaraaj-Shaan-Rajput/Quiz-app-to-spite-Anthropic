  ...
  "questions": [
    {
      ...
      "options": [
        ...
        "B. When the model predicts probability p, approximately p fraction of those predictions are actually correct",
    ...
    },
    {
      ...
      "options": [
        ...
        "B. When two models are equally accurate, the one with more confident predictions is more likely to win",
    ...
    },
    {
      ...
      "options": [
        ...
        "B. The incentive to extremify predictions would be reduced, rewarding honest probability estimates instead",
...

{
  ...
  "questions": [
    ...
    },
    {
      ...
      "options": [
        "A. Running code without provisioning or managing servers, with resources allocated automatically by a cloud provider",
